namespace InspireEd.Persistence.Users.Constants;

internal sealed class UserTableNames
{
    ...
    internal const string DeliveryPersonAvailabilities = nameof(DeliveryPersonAvailabilities);
